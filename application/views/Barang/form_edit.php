				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="input-group">
							<input type="text" class="form-control" name="barcode" id="barcode" value="<?php echo $record['barcode'] ?>" data-error="barcode Barang harus diisi" placeholder="barcode" value="" required />
