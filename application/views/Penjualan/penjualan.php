                                    ...
                                    <div class="form-group" style="margin-bottom:5px;">
                                        ...
                                        <form>
                                            <div class="form-group">
                                                <input class="form-control" name="idbarang" type="text" onkeyup="showResult(this.value)" placeholder="Ketik Nama Barang/Barcode">
                                        ...
                                        <table class="table table-striped list-table" style="margin:0;">
                                            <thead>
                                                <tr class="info">
                                                    ...
                                                    <th style="width: 20px;" class="satu absorbing-column">Pilihan</i></th>
                                                </tr>
                                            </thead>
                                            <div>
                                                        ...
                                                        if (!empty($this->cart->contents())) {
                                                            foreach ($this->cart->contents() as $items) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td align="center">
                                                                        <a href="#" onclick="location.href = '<?= base_url(); ?>index.php/hapus_cart/<?= $items['rowid']; ?>';" title="Batalkan" style="hover:mouse;"> Batalkan
                                ...
                                <div class="row">
                                    <div class="col-xs-6" style="padding: 0;">
                                        <div class="btn-group-vertical btn-block">
                                            <a href="<?php echo base_url() ?>index.php/cancel" class="btn btn-danger btn-block btn-rounded" style="max-width:150px;"id="reset"><i class="fa  fa-mail-reply"></i> Cancel</a>
                                        </div>
                                    </div>
                                    <div class="col-xs-6" style="padding: 0;">
                                        <a href="#" onclick="payment()" class="btn btn-success btn-block btn-rounded" id="pembayaran"><i class="fa fa-share-square-o"></i> Pembayaran</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                       ...
                                       <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="img1">
                                                        <img src="<?php echo  base_url('uploads/') . $row->foto; ?>" style="width: 20px; height: 20px;" class="img-responsive">
                                                    </td>
                                                    <td><?php echo $row->barcode; ?></td>
                                                    <td><?php echo $row->nama_barang; ?></td>
                                                    <td><?php echo $row->stok_barang ?></td>
                                                    <td><?= $this->fungsi->rupiah($row->harga); ?></td>
                                                    <td><a href="<?php echo base_url() . 'index.php/penjualan/tambah_barang/' . $row->id_barang . '/1' ?>"><i class="fa fa-check-square-o"></i> Ambil</a></td>
                                                </tr>
                                            </tbody>
                                            <?php } ?>
                                        </table> 
