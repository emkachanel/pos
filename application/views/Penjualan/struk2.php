    ...
    <div class='row'>
        <div class='col-xs-12'>
            <div class='box box-primary'>
                ...
                <div id="print-area" style="border:solid 1px red;">
                    <div class="box-body">
                        <div id="wrapper" style="border:solid 1px blue;">
                                ...
                                <div id="receipt-data">
                                    <div>
                                        <div style="text-align:center;border:solid 1px red;">
                                            ...
                                            <p style="text-align:center;"><strong>Toko Mumu</strong><br>Kp.babakan gorobog, Ds.Kadubale, Kec.Banjar, Kab.Pandeglang BANTEN 085774956742</p>
                                            <p><HR></HR></p>
                                        ...
                                        <table class="table table-striped table-condensed"style="border:solid 1px yellow;">
                                            <thead>
                                                <tr>
                                        ...
                                        <table class="table table-striped table-condensed" style="margin-top:10px; border:#000 solid 1px">
                                            <tbody>
                                                <tr>
