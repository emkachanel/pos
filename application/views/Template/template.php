...
<head>
	...
	<link rel="icon" href="<?=base_url()?>/assets/images/logologin.png" type="image/png">
...
<img src="<?php echo base_url('assets/images/bg2.png');?>" alt="gambar" class="bg">
	<div class="wrapper">
						...
						<li class="dropdown user user-menu">
							...
							<ul class="dropdown-menu">
								...
								<li class="user-body">
									...
									<a href="<?php echo base_url() ?>index.php/auth/logout" class="btn btn-danger btn-rounded" style="text-align:center;">keluar</a>
								</li>
							</ul>
						</li>
					</ul>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2022 <a target="_blank"href="https://www.youtube.com/channel/UCPMeugAJTOJunChARoamriw">Tambat Efendi Pratama</a> please subscribe my youtube chanel.<img class="img" src="<?= base_url('assets/images/youtube.png');?>" style="width:20px;"></img></div></strong> 
		</footer>
		<!-- /.control-sidebar -->
