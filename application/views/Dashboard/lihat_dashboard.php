			...
			<div class="box box-widget widget-user">
				<div class="widget-user-header bg-green-active">
					<p style="text-align: center;">
						<span style="font-family: georgia, palatino; font-size: 15pt;">Selamat datang di pos kasir berbasis web</span>
						<span style="font-family: georgia, palatino; font-size: 15pt;">aplikasi ini di kembangkan oleh tambat efendi pratama</span>
					</p>
				...
				<div class="box-footer">
					<div class="row">
						...
						<div class="col-sm-4 border-right">
							<div class="description-block">
								<h5 class="description-header">Kantor: Kp. Babakan Gorobog,Desa.kadubale, Kec.Banjar, Kab.Pandeglang, Provinsi</h5>
								<span class="description-text">No.Telp:085774956742</span>
							</div>
							<center>
